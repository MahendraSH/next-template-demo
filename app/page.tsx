...
const HomePage = () => {
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-gray-100 text-gray-800 p-6">
        <h1 className="text-4xl font-extrabold mb-4">Welcome to Next 14 Demo App</h1>
